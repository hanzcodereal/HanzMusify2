var Home = {
    ...
    renderDeveloperProfileView() {
        ...
        if (S.hc && S.hc.length > 0) {
            ...
            songsHtml = '<p class="text-white/60 text-sm py-4 col-span-2">Memuat lagu...</p>';
        }
            ...
            <div class="glass-strong rounded-3xl p-5 border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-transparent relative overflow-hidden ">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left relative z-10">
                    <div class="flex-1">
                        ...
                        <h2 class="text-2xl font-black text-white">Hanzz</h2>
                        <p class="text-xs text-[#b3b3b3] mt-1 leading-relaxed">Pengembang & Pembuat HanzMusify. Selamat menikmati streaming musik favorit tanpa gangguan!</p>
                        <div class="flex flex-wrap items-center gap-2 mt-3.5 justify-center sm:justify-start">
                            <a href="https://saweria.co/hanzreally" target="_blank" class="btn-chrome px-3.5 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-md active:scale-95 transition-all">
                                <i data-lucide="heart" class="w-3.5 h-3.5"></i> Support
                            </a>
