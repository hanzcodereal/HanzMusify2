    ...
    init(){
        ...
        <div class="pt-12 px-4 text-center">
            <div class="relative w-24 h-24 rounded-full mx-auto mb-6 glass-strong shine-sweep flex items-center justify-center overflow-hidden shadow-black/50">
                <img src="/logo.png" class="w-full h-full object-cover rounded-full" onerror="this.style.display='none'" />
            </div>
    ...
    showV3Popup() {
        ...
        popup.innerHTML = `
            <div class="glass-strong w-full max-w-sm rounded-3xl p-6 border border-white/10 text-center relative overflow-hidden" style="animation: slideUp 0.3s ease-out forwards;">
                ...
                <p class="text-white/70 text-xs mb-5">Fitur dan pembaruan terbaru:</p>
                <div class="space-y-4 text-left mb-6 max-h-[250px] overflow-y-auto pr-1">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-bold text-sm">Equalizer</h4>
                            <p class="text-[#b3b3b3] text-xs leading-relaxed">Sesuaikan Bass, Mid, Treble dengan berbagai Preset</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-bold text-sm">Share Lagu</h4>
                            <p class="text-[#b3b3b3] text-xs leading-relaxed">Bagikan link audio langsung ke teman</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-bold text-sm">Timer Tidur</h4>
                            <p class="text-[#b3b3b3] text-xs leading-relaxed">Atur waktu putar musik otomatis sebelum tidur</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-bold text-sm">Stop di Akhir Lagu</h4>
                            <p class="text-[#b3b3b3] text-xs leading-relaxed">Berhenti otomatis setelah lagu selesai</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-bold text-sm">Kecepatan Putar</h4>
                            <p class="text-[#b3b3b3] text-xs leading-relaxed">0.5x hingga 2.0x sesuai selera</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-bold text-sm">Slowed & Nightcore</h4>
                            <p class="text-[#b3b3b3] text-xs leading-relaxed">Mode audio spesial untuk gaya favorit</p>
                        </div>
                    </div>
                </div>
...
(function() {
    ...
    setTimeout(function() {
        if (sp) {
            ...
            sp.style.transition = 'opacity 0.5s ease, visibility 0.5s ease';
